...
const Login = () => {
    ...
    return (
        <div className="w-full max-w-md p-4 rounded-md mx-auto my-8 shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800">
            <h2 className="mb-3 text-3xl font-semibold text-center">Login to your account</h2>
            <p className="text-sm text-center dark:text-gray-600">Dont have account?
                <Link to="/signup" rel="noopener noreferrer" className="text-primary focus:underline hover:underline"> Sign up here</Link>
            </p>
            <div className="my-6 space-y-4">
                <button aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-primary transition-all duration-300 hover:shadow-xl hover:scale-105 hover:border-blue-500">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className='relative'>
                            ...
                            <p onClick={handleShowPassword} className='absolute left-[345px] top-3'>{showPassword ? <FaEye /> : <FaEyeSlash />}</p>
                        </div>
                    </div>
                </div>
