        ...
        <div className="card bg-base-100 w-96 shadow-sm transition-all duration-300 hover:shadow-xl hover:scale-105 hover:border-blue-500">
            ...
            <div className="card-body text-start">
                ...
                <div className="card-actions justify-end">
                    <button className="btn btn-primary   transition-all duration-300 hover:bg-blue-600 hover:ring-2 hover:ring-offset-2 hover:ring-blue-300 hover:scale-105 shadow">Add to cart</button>
                </div>
            </div>
        </div>
    );
